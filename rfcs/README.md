...
| [011](done/011-diff-view-tabs.md) | Diff View Tabs | 重要改善 | 左右差分 \| 統合 \| 変更のみ タブ |
| [012](done/012-linematch-rule-display.md) | LineMatch Rule Color Blocks | 重要改善 | ルールを色付きコードブロックで表示 |
